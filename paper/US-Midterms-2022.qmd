---
title: "Trump's 2024 Winning Coalition: Insights from the 2022 Comprehensive Election Study"
subtitle: "Logistic Regression Analysis Reveals Support for Trump Among Young Men and Infrequent Voters"
author: 
  - Talia Fabregas
...
Based on the results of applying the logistic regression model to predict vote preference, I estimate that young men, voters without a college education, and voters with low trust in government are likely to support Trump. The logistic regression vote preference model estimates ...

Based on the results of applying the logistic regression model to predict voter turnout, I estimate that voters with
...
@tbl-table1 shows that 71.4% of respondents who voted for Biden in 2020 voted in the 2022 midterm election, compared to 69.9% of respondents who voted for Trump. This 1.5-point midterm turnout gap between Biden 2020 and Trump 2020 voters in the 2022 CES survey could be related to the fact that Trump voters are more likely to distrust the government and have low civic engagement, and are therefore less likely to respond to a survey or vote in an election where he is not on the ballot [@silvergut]. As shown in @tbl-respondentvotepreference, Trump voters are underrepresented in the 2022 CES survey, so non-response bias will be a factor throughout this project.
...
The goal of my modeling strategy is twofold.
...
lp_table <- tibble(
  ...
  `Estimated 2022 turnout %` = round(mean(lp_turnout$predicted_prob)*100, 2)
)
kable(lp_table)
